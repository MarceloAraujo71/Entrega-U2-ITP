...
Este repositório contém os seguintes exercícios em Linguagem C, envolvendo vetores (arrays), estruturas (structs) e algoritmos de ordenação:

* **`problema1.c`**: Estou com sorte (ou não).
* **`problema2.c`**: Os dias mais chuvosos.
* **`problema3.c`**: Esse sim é piloto.
