...
Este repositório contém os seguintes exercícios em Linguagem C, envolvendo matrizes e grafos simples:

* **`problema1.c`**: Campo Agrícola.
* **`problema2.c`**: Sugestão de amigos.
* **`problema3.c`**: Campeonato de empates.
* **`problema4.c`**: Uma pechincha!.
